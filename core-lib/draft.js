...
let floorBelongingsPointerStartsAt

// keep !
for(floorBelongingsPointerStartsAt = 0; floorBelongingsPointerStartsAt < Array.from(Array(14)).length; floorBelongingsPointerStartsAt++) {
    let spawnedPointerBelongingsStarting = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1, 1, 3 * 1 + floorBelongingsPointerStartsAt)
    let knotStarting = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 4 * 2, 1 * 0.5, 4 * 1 * 2)
    pencil.useKnot(knotStarting)

    // keep
    pencil.useSpawn(spawnedPointerBelongingsStarting)

    pencil.draw()

    // keep

    let spawnedPointerBelongingsAnother = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1 * 4 * 2 + 0.7, 1, 3 * 1 + floorBelongingsPointerStartsAt)
    let knot2 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 0.5 * 0.5, 1, 4 * 1 * 2)
    pencil.useKnot(knot2)
    ...
    let spawnedPointerBelongingsRemaining = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1, 1, 3 * 1 + floorBelongingsPointerStartsAt)
    let knot3 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 3.5 * 2 + 0.5, 1, 1 * 0.5)
    pencil.useKnot(knot3)
    ...
    let spawnedPointerBelongingsRest = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1, 1 * 4 * 2 + 0.5, 3 * 1 + floorBelongingsPointerStartsAt)
    let knot4 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 3.5 * 2 + 0.5, 1, 1 * 0.5)
    pencil.useKnot(knot4)
    ...
    let spawnedPointerBelongingsFiveth = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1, 1 * 3 + 0.5 + 0.5 + 0.5, 3 * 1 + floorBelongingsPointerStartsAt)
    let knot5 = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 + 0.5, 1, 1)
    pencil.useKnot(knot5)
    ...
    for(let i = 1; i <= Array.from(Array(3)).length; i++) {
        let counter = i
        let spawnedPointerBelongingsVertical = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1, 1 + 0.5 + 0.7 * counter, 3 * 1 + floorBelongingsPointerStartsAt)
        let knotVertical = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 + 0.5, 1, 1 * 0.5 * 0.5)
        pencil.useKnot(knotVertical)
...
let spawnedPointerBelongingsClosing = draftFabrikk.spawnPointerBelongingsAtRectangle(/* keep */ /* y, x, z */ spawnedPointerBelongings.y, spawnedPointerBelongings.x, debPointer, /* radius, d, f, frontRatio */ radius, 0.9, 0.4, 1, /* keep */ /* debthScaleRatio, frontScaleRatio, profileScaleRatio */ 1, 1, 3 * 1 + floorBelongingsPointerStartsAt)
let knotClosing = draftFabrikk.constructKnot(/* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 * 4 * 2, 1, 4 * 1 * 2)
